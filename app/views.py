...
def done(request, obj1, obj2, obj3):
    ...
    rent = obj2
    address = obj3
    print("Soham is great",ownername, buyername, gender, qualification, email, rent, address )
...
def roommate(request, obj1, obj2):
    ...
    if request.method == "POST":
        ...
        if ( len(username) and len(address) and len(rent) and len(lastdate)) == 0:
            ...
            print("Vedika", username, address, state, city, area, room_mate_present, room_mate_require, rent, file, lastdate)
            ins.save()
